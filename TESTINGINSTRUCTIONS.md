...
7.  Fill up the file information (Paste the copied IPFS, enter a file name, and enter the specific subject/course) on the UploadFile function
8.  Click Transact
9.  Complete transaction
10.  Click the getCourses function and input the subject name
11.  Get the fileID by finding the File number
